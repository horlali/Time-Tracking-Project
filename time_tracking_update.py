...
services = input('Enter task to be performed here \n')
...
amount_charged = int(input('Enter the amount you charge for this service \n'))
amount_due = round((time_spent*amount_charged))
